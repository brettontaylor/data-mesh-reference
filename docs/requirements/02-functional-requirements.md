...
| FR-AX-004 | M | The system SHALL implement **RBAC** with roles (viewer, modeler, steward, domain_owner, platform_engineer, governance, admin) mapped from IdP groups. | Each role grants only its capabilities; group→role mapping is configurable. |
